...
pipeline {
    ...
    stages {
        ...
        stage('Deployment develop') {
            ...
            steps {
                // Update git repos.
                sh "ansible srvitkphp72stg -m shell -a 'cd /home/deploy/www/b7_srvitkphp72stg_itkdev_dk/htdocs; git clean -d --force'"
                sh "ansible srvitkphp72stg -m shell -a 'cd /home/deploy/www/b7_srvitkphp72stg_itkdev_dk/htdocs; git checkout ${BRANCH_NAME}'"
                sh "ansible srvitkphp72stg -m shell -a 'cd /home/deploy/www/b7_srvitkphp72stg_itkdev_dk/htdocs; git fetch'"
                sh "ansible srvitkphp72stg -m shell -a 'cd /home/deploy/www/b7_srvitkphp72stg_itkdev_dk/htdocs; git reset origin/${BRANCH_NAME} --hard'"
        ...
        stage('Deployment production') {
            ...
            steps {
                ...
                sh "ansible srvitkphp72 -m shell -a 'cd /home/deploy/www/b7_itkdev_dk/htdocs; git checkout ${BRANCH_NAME}'"
                sh "ansible srvitkphp72 -m shell -a 'cd /home/deploy/www/b7_itkdev_dk/htdocs; git fetch'"
